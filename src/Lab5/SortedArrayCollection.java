...
public class SortedArrayCollection<T> implements CollectionInterface<T> {
    ...
    public String toString(){           //returns a string show the contents of the collection
    ...
    //combines the contents of 2 different collections
    public SortedArrayCollection<T> combine(SortedArrayCollection<T> other){

        SortedArrayCollection<T> toReturn;
        toReturn = new SortedArrayCollection<T>();
        for (int i = 0; i < other.size(); i++)
        {
            toReturn.add(other.elements[i]);
        }
        for (int i = 0; i < numElements; i++)
        {
